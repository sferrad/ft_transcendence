...
const NotFound = () => {
    ...
    return (
        <div className="relative min-h-[100dvh] w-full bg-[url('/assets/bg404.jpg')] bg-cover bg-center bg-no-repeat flex flex-col items-center justify-center px-4 py-10">
