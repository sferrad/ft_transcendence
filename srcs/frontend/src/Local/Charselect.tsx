            ...
            <div className="min-h-[100dvh] w-full px-4 py-8 flex flex-col items-center justify-center gap-8 hb-landscape-compact">
                ...
                <button
                    onClick={() => {
                        ...
                        navigate(`/solo-gameplay?player=${encodeURIComponent(player)}&ai=${encodeURIComponent(ai)}&playerName=${encodeURIComponent(player1DisplayName)}&player2=${encodeURIComponent(opponentName)}`);
                    }}
