...
export const deleteAccount = async (currentPassword: string, t: TFunction): Promise<boolean> => {
    if (!currentPassword) {
        ...
        <div>
            ...
            <div className="absolute inset-0 flex justify-center items-center z-10">
                <div className="bg-[#f5f0e8]/90 border-4 border-[#2b2b2b] px-10 py-12 text-center shadow-[6px_6px_0_#2b2b2b] w-110 flex flex-col items-center">
                    <h1 className="text-7xl font-arcade tracking-widest text-[#1f2937] mb-6">{t("Delete Account")}</h1>
