...
const Charselectsolo = () => {
    ...
    return (
        <div className="fixed inset-0 bg-[url('/assets/bgSoloselect.jpg')] bg-cover bg-center bg-no-repeat ">
            ...
            <button onClick={() => window.location.href = "/game"} className='absolute bottom-35 left-1/2 transform -translate-x-1/2 px-15 py-10 text-xl text-white bg-green-600 hover:bg-green-700 rounded-lg transition-colors duration-200'>Start Game</button>
        </div>
    );
}
