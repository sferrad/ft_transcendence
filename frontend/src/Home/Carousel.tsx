    ...
    return (
        <div className="flex items-end justify-center h-screen pb-20 text-2xl">
            <div className="flex items-center justify-center border-2 border-gray-300 bg-gradient-to-r from-blue-500 to-red-500 rounded-xl px-8 py-6 gap-4">
                <button className="mx-2 text-5xl hover:scale-110 transition-transform text-blue-300 border-2 border-gray-300 rounded-lg p-2" onClick={prev}><FaRegArrowAltCircleLeft /></button>
                ...
                ${isActive
                                        ? 'z-20 scale-125 text-white shadow-xl'
                ...
                <button className="mx-2 text-5xl hover:scale-110 transition-transform text-blue-300 border-2 border-gray-300 rounded-lg p-2" onClick={next}><FaRegArrowAltCircleRight /></button>
            </div>
        </div>
    );
}
